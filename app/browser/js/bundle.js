...
},{"../../../lib/client":51,"jquery":4}],2:[function(require,module,exports){
var $ = require('jquery');
...
},{"../../../lib/model.js":53,"jquery":4}],3:[function(require,module,exports){
...
},{"../transport":18,"component-inherit":26,"debug":12,"engine.io-parser":27,"parseqs":38,"ws":3,"yeast":39}],24:[function(require,module,exports){
...
},{"../model.js":53,"./rule.js":56}],55:[function(require,module,exports){
var model = require('../model.js');
var Rule = require('./rule.js');
 ...
 * Reset board to initial position of pieces.
 */
RuleBgGulbara.prototype.resetBoard = function(board) {
  /**
   * Move pieces to correct initial positions for both players.
   * Values in board.points are zero based and denote the .
   * the number of pieces on each position.
  ...
  board.place(15, model.PieceType.WHITE, 23);

  board.place(15, model.PieceType.BLACK, 11);
};
...
},{"../model.js":53}],"socket.io-client":[function(require,module,exports){
...
},{"./manager":5,"./socket":7,"./url":8,"debug":12,"socket.io-parser":45}]},{},[1]);
